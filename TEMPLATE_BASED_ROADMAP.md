...
- ✅ **PTOCA Templating**: Extended templating to PTOCA control sequences (AMI, RMI, AMB, RMB, SCFL, SBI, SIM, BSU, ESU, SVI, BLN, STO, SIA, STC, USC, SEC) and Structured Fields (PTD1).
