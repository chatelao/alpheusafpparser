...
| PTOCA-5-030 | EC-0001: Invalid or unsupported function type in control sequence. | ✅ |
| PTOCA-5-041 | EC-0F01: Baseline or inline orientation specified is not a valid or supported value. | ✅ |
| PTOCA-5-054 | EC-1C01: The class of a X'2B' control sequence is not X'D3'. | ✅ |
| PTOCA-5-055 | EC-1E01: A required parameter has not been not specified. | ✅ |
| PTOCA-5-056 | EC-1E01: Invalid control sequence or initial text condition parameter length. | ✅ |
| PTOCA-6-007 | Recognition of control sequences, chained or unchained | ✅ |
| PTOCA-6-012 | PT1 subset DBR parameter range | ✅ |
| PTOCA-6-013 | PT1 subset DIR parameter range | ✅ |
| PTOCA-6-014 | PT1 subset RPS parameter range | ✅ |
| PTOCA-6-015 | PT1 subset SIA parameter range | ✅ |
| PTOCA-6-016 | PT1 subset STC parameter range | ✅ |
| PTOCA-6-017 | PT1 subset STO parameter range | ✅ |
| PTOCA-6-028 | PT1 subset STC PRECISION parameter retired | ✅ |
| PTOCA-6-032 | PT2 subset OVS parameter range | ✅ |
| PTOCA-6-035 | PT2 subset STC parameter range | ✅ |
| PTOCA-6-036 | PT2 subset STO parameter range | ✅ |
| PTOCA-6-037 | PT2 subset TBM parameter range (direction, precision) | ✅ |
| PTOCA-6-038 | PT2 subset TBM parameter range (increment) | ✅ |
| PTOCA-6-039 | PT2 subset USC parameter range | ✅ |
| PTOCA-6-042 | PT2 subset SCFL parameter range | ✅ |
| PTOCA-6-055 | PT3 subset STC parameter range | ✅ |
| PTOCA-6-056 | PT3 subset STO parameter range | ✅ |
| PTOCA-6-070 | PT4 subset GLC OIDLGTH range | ✅ |
| PTOCA-6-071 | PT4 subset GLC FFNLGTH range | ✅ |
| PTOCA-6-072 | PT4 subset GLC FONTOID (first byte) X'06' | ✅ |
| PTOCA-6-077 | PT4 subset STO parameter range | ✅ |
