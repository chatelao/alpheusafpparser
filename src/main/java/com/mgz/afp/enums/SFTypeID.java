...
public enum SFTypeID {
  ...
  MID_ManageIPDSDialog(0xD6, 0x01, 0x00),
  SHS_SetHomeState(0xD6, 0x97, 0x00),
  NOP_NoOperation_IPDS(0xD6, 0x03, 0x00),
  BP_BeginPage(0xD6, 0xAF, 0x00),
  EP_EndPage(0xD6, 0xBF, 0x00),
  END_End(0xD6, 0x5D, 0x00),
  STM_SenseTypeAndModel(0xD6, 0xE4, 0x00),
  LPP_LogicalPagePosition(0xD6, 0x6D, 0x00),
  LPD_LogicalPageDescriptor(0xD6, 0xCF, 0x00),
  LCC_LoadCopyControl(0xD6, 0x9F, 0x00),
  DF_DeactivateFont(0xD6, 0x4F, 0x00),
  DUA_DefineUserArea(0xD6, 0xCE, 0x00),
  AFO_ApplyFinishingOperations(0xD6, 0x02, 0x00),
  ASN_ActivateSetupName(0xD6, 0x0A, 0x00),
  SPE_SetPresentationEnvironment(0xD6, 0x08, 0x00),
  ISP_IncludeSavedPage(0xD6, 0x7E, 0x00),
  ICMR_InvokeCMR(0xD6, 0x6B, 0x00),
  LFE_LoadFontEquivalence(0xD6, 0x3F, 0x00),
  PFC_PresentationFidelityControl_IPDS(0xD6, 0x34, 0x00),
  LE_LoadEquivalence(0xD6, 0x1D, 0x00),
  WT_WriteText(0xD6, 0x2D, 0x00),
  WIC_WriteImageControl(0xD6, 0x3D, 0x00),
  WI_WriteImage(0xD6, 0x4D, 0x00),
  WIC2_WriteImageControl2(0xD6, 0x3E, 0x00),
  WI2_WriteImage2(0xD6, 0x4E, 0x00),
  BO_BeginOverlay(0xD6, 0xDF, 0x00),
  DO_DeactivateOverlay(0xD6, 0xEF, 0x00),
  IO_IncludeOverlay(0xD6, 0x7D, 0x00),
  BPS_BeginPageSegment_IPDS(0xD6, 0x5F, 0x00),
  DPS_DeactivatePageSegment_IPDS(0xD6, 0x6F, 0x00),
  IPS_IncludePageSegment_IPDS(0xD6, 0x7F, 0x00),
  WBCC_WriteBarCodeControl(0xD6, 0x80, 0x00),
  WBC_WriteBarCode(0xD6, 0x81, 0x00),
  WOCC_WriteObjectContainerControl(0xD6, 0x3C, 0x00),
  WOC_WriteObjectContainer(0xD6, 0x4C, 0x00),
  WGC_WriteGraphicsControl(0xD6, 0x84, 0x00),
  WG_WriteGraphics(0xD6, 0x85, 0x00),
  WMC_WriteMetadataControl(0xD6, 0x8A, 0x00),
  WM_WriteMetadata(0xD6, 0x8B, 0x00),
  LFI_LoadFontIndex(0xD6, 0x0F, 0x00),
  LFCSC_LoadFontCharacterSetControl(0xD6, 0x19, 0x00),
  LCPC_LoadCodePageControl(0xD6, 0x1A, 0x00),
  LCP_LoadCodePage(0xD6, 0x1B, 0x00),
  LSS_LoadSymbolSet(0xD6, 0x1E, 0x00),
  LFC_LoadFontControl(0xD6, 0x1F, 0x00),
  LF_LoadFont(0xD6, 0x2F, 0x00),
  ;
