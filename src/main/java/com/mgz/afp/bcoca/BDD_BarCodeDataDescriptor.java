...
public class BDD_BarCodeDataDescriptor extends StructuredField {
  ...
  public enum BarCodeType {
    ...
    Code_128__GS1_128__UCC_EAN_128__AIM_USS_128__IntelligentMail__ContainerBarcode(0x11, false, true, new byte[] {0x02, 0x03, 0x04, 0x05, 0x06}),
    ...
    DataMatrix_GS1DataMatrix_2D(0x1C, false, true, new byte[] {0x00, 0x01}),
    ...
    QRCode_2D(0x20, false, true, new byte[] {0x02, 0x12}),
    ...
    RoyalMail_Mailmark(0x25, false, false, new byte[] {0x00, 0x01}),
    AztecCode(0x26, false, false, new byte[] {0x00, 0x01, 0x02, 0x03}),
    HanXinCode(0x27, false, false, new byte[] {0x00}),
