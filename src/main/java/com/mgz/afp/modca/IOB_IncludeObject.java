...
/**
 * MO:DCA, page 200.<br> and Programming Guide and Line Data Reference(ha3l3r04.pdf), page 200.<br>
 * <br> An Include Object structured field references an object and optionally contains parameters
 * that identify the object and that specify presentation parameters such as object position, size,
 * orientation, mapping, and default color. Where the presentation parameters conflict with
 * parameters specified in the object’s environment group (OEG), the parameters in the Include
 * Object structured field override. If the referenced object is a page segment, the IOB parameters
