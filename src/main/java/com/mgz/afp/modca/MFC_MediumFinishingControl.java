...
/**
 * MO:DCA, page 262.<br> <br> The Medium Finishing Control structured field specifies the finishing
 * requirements for physical media. Finishing can be specified for a media collection at the print
 * file level or at the document level by placing the MFC in the document environment group (DEG) of
 * the form map. Finishing can be specified for a media collection at the medium map level by
 * placing the MFC in a medium map. Finishing can be specified for individual media, or sheets, at
 * the medium map level by placing the MFC in a medium map.
 */
