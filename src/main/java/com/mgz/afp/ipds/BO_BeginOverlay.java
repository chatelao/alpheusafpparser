...
/**
 * IPDS Begin Overlay (BO) Command (X'D6DF').
 * Refer to IPDS-12-002, IPDS-12-008, IPDS-12-010.
 */
public class BO_BeginOverlay extends IPDSCommand {
  ...
  public void decodeAFP(byte[] sfData, int offset, int length, AFPParserConfiguration config)
    ...
    if (remaining == 1) {
      ...
      throw new AFPParserException("BO: Missing overlay ID/HAID");
    }
  }
