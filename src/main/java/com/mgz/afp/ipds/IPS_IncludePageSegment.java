...
/**
 * IPDS Include Page Segment (IPS) Command (X'D67F').
 * Refer to IPDS-13-004, IPDS-13-010.
 */
public class IPS_IncludePageSegment extends IPDSCommand {
  ...
  public void decodeAFP(byte[] sfData, int offset, int length, AFPParserConfiguration config)
    ...
    if (remaining >= 2) {
      ...
      throw new AFPParserException("IPS: Missing HAID");
    }
  }
