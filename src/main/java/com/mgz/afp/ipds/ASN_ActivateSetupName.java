...
/**
 * IPDS Activate Setup Name (ASN) Command (X'D60A').
 * Refer to IPDS-4-003, IPDS-4-265.
 */
public class ASN_ActivateSetupName extends IPDSCommand implements IHasTriplets {
