...
/**
 * IPDS Deactivate Page Segment (DPS) Command (X'D66F').
 * Refer to IPDS-13-003, IPDS-13-008.
 */
public class DPS_DeactivatePageSegment extends IPDSCommand {
  ...
  public void decodeAFP(byte[] sfData, int offset, int length, AFPParserConfiguration config)
    ...
    if (remaining >= 2) {
      ...
      throw new AFPParserException("DPS: Missing HAID");
    }
  }
