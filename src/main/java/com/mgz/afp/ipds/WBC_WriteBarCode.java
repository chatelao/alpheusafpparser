...
/**
 * IPDS Write Bar Code (WBC) Command (X'D681').
 * Refer to IPDS-9-076.
 */
public class WBC_WriteBarCode extends IPDSCommand {
  ...
  public void decodeAFP(byte[] sfData, int offset, int length, AFPParserConfiguration config) throws AFPParserException {
    ...
    if (remaining > 0) {
      this.barCodeData = new byte[remaining];
      System.arraycopy(sfData, offset + consumed, this.barCodeData, 0, remaining);
    }
  }
