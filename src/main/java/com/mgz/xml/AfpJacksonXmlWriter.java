...
public class AfpJacksonXmlWriter implements StructuredFieldHandler {
  ...
  private void writeControlSequence(PTOCAControlSequence cs, int level) throws Exception {
    ...
    if (cs instanceof PTOCAControlSequence.TRN_TransparentData trn) {
      ...
      baseXsw.writeIntAttribute(null, null, "displacement", (int) ami.getDisplacement());
      MnemonicPerformanceMonitor.endWrite();
      ...
      baseXsw.writeIntAttribute(null, null, "x", x);
      baseXsw.writeIntAttribute(null, null, "y", y);
      baseXsw.writeIntAttribute(null, null, "displacement", (int) amb.getDisplacement());
      MnemonicPerformanceMonitor.endWrite();
      ...
      baseXsw.writeIntAttribute(null, null, "x", x);
      baseXsw.writeIntAttribute(null, null, "y", y);
      baseXsw.writeIntAttribute(null, null, "increment", (int) rmi.getIncrement());
      MnemonicPerformanceMonitor.endWrite();
      ...
      baseXsw.writeIntAttribute(null, null, "x", x);
      baseXsw.writeIntAttribute(null, null, "y", y);
      baseXsw.writeIntAttribute(null, null, "increment", (int) rmb.getIncrement());
      MnemonicPerformanceMonitor.endWrite();
      ...
      baseXsw.writeIntAttribute(null, null, "displacement", (int) sim.getDisplacement());
      MnemonicPerformanceMonitor.endWrite();
      ...
      baseXsw.writeIntAttribute(null, null, "codedFontLocalID", (int) scfl.getCodedFontLocalID());
      MnemonicPerformanceMonitor.endWrite();
      ...
      baseXsw.writeIntAttribute(null, null, "increment", (int) sbi.getIncrement());
      MnemonicPerformanceMonitor.endWrite();
      ...
      baseXsw.writeIntAttribute(null, null, "suppressionID", (int) bsu.getSuppressionID());
      MnemonicPerformanceMonitor.endWrite();
      ...
      baseXsw.writeIntAttribute(null, null, "suppressionID", (int) esu.getSuppressionID());
      MnemonicPerformanceMonitor.endWrite();
      ...
      baseXsw.writeIntAttribute(null, null, "increment", (int) svi.getIncrement());
      MnemonicPerformanceMonitor.endWrite();
      ...
      baseXsw.writeIntAttribute(null, null, "x", getAfpX());
      baseXsw.writeIntAttribute(null, null, "y", getAfpY());
      baseXsw.writeIntAttribute(null, null, "length", (int) dir.getLength());
      if (dir.getWidth() != null) {
        baseXsw.writeIntAttribute(null, null, "width", (int) dir.getWidth());
        if (dir.getWidthFraction() != null) {
          baseXsw.writeIntAttribute(null, null, "widthFraction", (int) dir.getWidthFraction());
        }
      }
      MnemonicPerformanceMonitor.endWrite();
      ...
      baseXsw.writeIntAttribute(null, null, "x", getAfpX());
      baseXsw.writeIntAttribute(null, null, "y", getAfpY());
      baseXsw.writeIntAttribute(null, null, "length", (int) dbr.getLength());
      if (dbr.getWidth() != null) {
        baseXsw.writeIntAttribute(null, null, "width", (int) dbr.getWidth());
        if (dbr.getWidthFraction() != null) {
          baseXsw.writeIntAttribute(null, null, "widthFraction", (int) dbr.getWidthFraction());
        }
      }
      MnemonicPerformanceMonitor.endWrite();
      ...
      if (tbm.getTemporaryBaselineIncrement() != null) {
        baseXsw.writeIntAttribute(null, null, "temporaryBaselineIncrement", (int) tbm.getTemporaryBaselineIncrement());
      }
      MnemonicPerformanceMonitor.endWrite();
      ...
      baseXsw.writeIntAttribute(null, null, "overStrikeCharacterCodePoint", (int) ovs.getOverStrikeCharacterCodePoint());
      if (ovs.getText() != null) {
