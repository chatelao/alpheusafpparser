...
public class AfpJacksonXmlWriter implements StructuredFieldHandler {
  ...
  private void writeTriplet(XMLStreamWriter2 writer, Triplet triplet, int level) throws Exception {
    ...
    if (triplet instanceof Triplet.Undefined u) {
      ...
      XmlTemplateRegistry.getTemplate("OCNT").writeObjects(
          baseXsw, (int) oc.subordinateObjectType, (int) oc.reserved3, oc.numberOfObjectsLow, extra);
      ...
      XmlTemplateRegistry.getTemplate("OO").writeObjects(
          baseXsw, typeAttr, (int) oo.reserved3, oo.nrOfPrecedingObjectsLow, extra);
  ...
  private void writePtdFormat1Directly(PTD_PresentationTextDataDescriptor_Format1 ptd, int level) throws Exception {
    ...
    XmlTemplateRegistry.getTemplate("PTD1").writeObjects(
        baseXsw, typeAttr, yUbAttr, ptd.getxUnitsPerUnitBase(),
        ptd.getyUnitsPerUnitBase(), ptd.getxSize(), ptd.getySize(), extra);
    MnemonicPerformanceMonitor.endWrite();
  }
