...
public class AfpJacksonXmlWriter implements StructuredFieldHandler {
  ...
  private void writePtdFormat1Directly(PTD_PresentationTextDataDescriptor_Format1 ptd,
    ...
    String xUbAttr = ptd.getxUnitBase() != null
    ...
    String extra = ptd.getReserved10_11() != null
        ...
        : "";
    XmlTemplateRegistry.getTemplate("PTD1").writeObjects(baseXsw, xUbAttr, yUbAttr,
        ptd.getxUnitsPerUnitBase(), ptd.getyUnitsPerUnitBase(), ptd.getxSize(), ptd.getySize(),
        extra);
    MnemonicPerformanceMonitor.endWrite();
  }
