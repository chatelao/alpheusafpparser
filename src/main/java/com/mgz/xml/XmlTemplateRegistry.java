...
public class XmlTemplateRegistry {
  ...
  static {
    ...
    register("AMI", new String[] {
        "<AMI_AbsoluteMoveInline page=\"", "\" x=\"", "\" y=\"", "\" displacement=\"", "\"/>"});
    register("RMI", new String[] {
        "<RMI_RelativeMoveInline page=\"", "\" x=\"", "\" y=\"", "\" increment=\"", "\"/>"});
    register("AMB", new String[] {
        "<AMB_AbsoluteMoveBaseline page=\"", "\" x=\"", "\" y=\"", "\" displacement=\"", "\"/>"});
    register("RMB", new String[] {
        "<RMB_RelativeMoveBaseline page=\"", "\" x=\"", "\" y=\"", "\" increment=\"", "\"/>"});
    register("SCFL", new String[] {
        "<SCFL_SetCodedFontLocal codedFontLocalID=\"", "\"/>"});
    register("SBI", new String[] {
        "<SBI_SetBaselineIncrement increment=\"", "\"/>"});
    register("SIM", new String[] {
        "<SIM_SetInlineMargin displacement=\"", "\"/>"});
    register("BSU", new String[] {
        "<BSU_BeginSuppression suppressionID=\"", "\"/>"});
    register("ESU", new String[] {
        "<ESU_EndSuppression suppressionID=\"", "\"/>"});
    register("SVI", new String[] {
        "<SVI_SetVariableSpaceCharacterIncrement increment=\"", "\"/>"});
    register("BLN", new String[] {
        "<BLN_BeginLine page=\"", "\" x=\"", "\" y=\"", "\"/>"});
    register("STO", new String[] {
        "<STO_SetTextOrientation page=\"", "\" x=\"", "\" y=\"", "\" xOrientation=\"",
        "\" yOrientation=\"", "\"/>"});
    register("SIA", new String[] {
        "<SIA_SetIntercharacterAdjustment adjustment=\"", "\" direction=\"", "\"/>"});
    register("STC", new String[] {
        "<STC_SetTextColor foregroundColor=\"", "\" precision=\"", "\"/>"});
    register("USC", new String[] {
        "<USC_Underscore bypassFlag=\"", "\"/>"});
    register("DIR", new String[] {
        "<DIR_DrawIaxisRule page=\"", "\" x=\"", "\" y=\"", "\" length=\"", "\"", "/>"});
    register("DBR", new String[] {
        "<DBR_DrawBaxisRule page=\"", "\" x=\"", "\" y=\"", "\" length=\"", "\"", "/>"});
    ...
    register("ROT", new String[] {
        "<ResourceObjectType objectType=\"", "\"/>"});
    register("DP", new String[] {
        "<DescriptorPosition objectAreaDescriptorID=\"", "\"/>"});
    register("MEC", new String[] {
        "<MediaEjectControl reserved2=\"", "\" mediaEjectControl=\"", "\"/>"});
    register("RUA", new String[] {
        "<ResourceUsageAttribute frequencyOfUse=\"", "\"/>"});
    ...
    register("ERLI", new String[] {
        ...
        "\"/>"});
    register("RSN", new String[] {
        "<ResourceSectionNumber resourceSectionNumber=\"", "\"/>"});
    register("MMPN", new String[] {
        "<MediumMapPageNumber pageNumber=\"", "\"/>"});
    register("OBE", new String[] {
        "<ObjectByteExtent byteExtentLow=\"", "\" byteExtentHigh=\"", "\"/>"});
    register("FHSF", new String[] {
        "<FontHorizontalScaleFactor horizontalScaleFactor=\"", "\"/>"});
    register("MOR", new String[] {
        "<MediumOrientation mediumOrientation=\"", "\"/>"});
    register("TS", new String[] {
        "<TonerSaver reserved2=\"", "\" tonerSaverFunction=\"", "\"/>"});
    ...
    register("PPI", new String[] {
        "<PagePositionInformation repeatingGroupNumber=\"", "\"/>"});
    register("TO", new String[] {
        "<TextOrientation xOrientation=\"", "\" yOrientation=\"", "\"/>"});
    register("LDOPM", new String[] {
        "<LineDataObjectPositionMigration locationAndOrientation=\"", "\"/>"});
    register("KGT", new String[] {
        "<KeepGroupTogether grpFnct=\"", "\"/>"});
    register("FCGCS", new String[] {
        "<FontCodedGraphicCharacterSetGlobalID codedGraphicCharacterSetGlobalID=\"",
        "\" codePageGlobalID=\"", "\"/>"});
    register("MFS", new String[] {
        "<MODCAFunctionSet fctSetID=\"", "\"/>"});
    ...
    register("OBO", new String[] {
        "<ObjectByteOffset byteOffset=\"", "\"", "/>"});
    register("OSFO", new String[] {
        "<ObjectStructuredFieldOffset offsetLow=\"", "\"", "/>"});
    ...
    register("SEC", new String[] {
        "<SEC_SetExtendedTextColor colorSpace=\"", "\" nrOfBitsComponent1=\"",
        "\" nrOfBitsComponent2=\"", "\" nrOfBitsComponent3=\"", "\" nrOfBitsComponent4=\"",
        "\" colorValue=\"", "\"/>"});
    register("TBM", new String[] {
        "<TBM_TemporaryBaselineMove page=\"", "\" x=\"", "\" y=\"", "\"", "/>"});
    register("OVS", new String[] {
        "<OVS_Overstrike page=\"", "\" x=\"", "\" y=\"", "\"", "/>"});
    register("RPL", new String[] {
        "<repeatLength>", "</repeatLength>"});

    register("TRN_START", new String[] {
        "<TRN_TransparentData page=\"", "\" x=\"", "\" y=\"", "\">"});
    register("GC_START", new String[] {
        "<GraphicCharacters page=\"", "\" x=\"", "\" y=\"", "\">"});
    register("RPS_START", new String[] {
        "<RPS_RepeatString page=\"", "\" x=\"", "\" y=\"", "\">"});
  }
  ...
  /**
   * Returns the XML template for the given mnemonic.
   *
