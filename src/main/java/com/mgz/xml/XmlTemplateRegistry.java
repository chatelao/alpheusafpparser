...
public class XmlTemplateRegistry {
  ...
  static {
    ...
    register("OCNT", new String[] {
        "<ObjectCount subordinateObjectType=\"",
        "\" reserved3=\"",
        "\" numberOfObjectsLow=\"",
        "\"",
        " />"});
    register("LODTS", new String[] {"<LocalObjectDateAndTimeStamp dateAndTimeStampType=\"",
        "\" hundreds=\"", "\" tens=\"", "\" dayOfYear=\"", "\" hourOfDay=\"",
        "\" minuteOfHour=\"", "\" secondOfMinute=\"", "\" hundredthOfSecond=\"", "\"/>"});
    ...
    register("PTD1", new String[] {
        "<PTD_PresentationTextDataDescriptor_Format1",
        "",
        " xUnitsPerUnitBase=\"",
        "\" yUnitsPerUnitBase=\"",
        "\" xSize=\"",
