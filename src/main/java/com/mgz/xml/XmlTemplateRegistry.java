...
public class XmlTemplateRegistry {
  ...
  static {
    ...
    register("AMI", new String[] {"<AMI_AbsoluteMoveInline page=\"", "\" x=\"", "\" y=\"",
        "\" displacement=\"", "\"/>"});
    register("RMI", new String[] {"<RMI_RelativeMoveInline page=\"", "\" x=\"", "\" y=\"",
        "\" increment=\"", "\"/>"});
    register("AMB", new String[] {"<AMB_AbsoluteMoveBaseline page=\"", "\" x=\"", "\" y=\"",
        "\" displacement=\"", "\"/>"});
    register("RMB", new String[] {"<RMB_RelativeMoveBaseline page=\"", "\" x=\"", "\" y=\"",
        "\" increment=\"", "\"/>"});
    register("SCFL", new String[] {"<SCFL_SetCodedFontLocal page=\"", "\" x=\"", "\" y=\"",
        "\" codedFontLocalID=\"", "\"/>"});
    register("SBI", new String[] {"<SBI_SetBaselineIncrement page=\"", "\" x=\"", "\" y=\"",
        "\" increment=\"", "\"/>"});
    register("SIM", new String[] {"<SIM_SetInlineMargin page=\"", "\" x=\"", "\" y=\"",
        "\" displacement=\"", "\"/>"});
    register("BSU", new String[] {"<BSU_BeginSuppression page=\"", "\" x=\"", "\" y=\"",
        "\" suppressionID=\"", "\"/>"});
    register("ESU", new String[] {"<ESU_EndSuppression page=\"", "\" x=\"", "\" y=\"",
        "\" suppressionID=\"", "\"/>"});
    register("SVI", new String[] {"<SVI_SetVariableSpaceCharacterIncrement page=\"", "\" x=\"",
        "\" y=\"", "\" increment=\"", "\"/>"});
    register("BLN", new String[] {"<BLN_BeginLine page=\"", "\" x=\"", "\" y=\"", "\"/>"});
    register("STO", new String[] {"<STO_SetTextOrientation page=\"", "\" x=\"", "\" y=\"",
        "\" xOrientation=\"", "\" yOrientation=\"", "\"/>"});
    register("SIA", new String[] {"<SIA_SetIntercharacterAdjustment page=\"", "\" x=\"", "\" y=\"",
        "\" adjustment=\"", "\" direction=\"", "\"/>"});
    register("STC", new String[] {"<STC_SetTextColor page=\"", "\" x=\"", "\" y=\"",
        "\" foregroundColor=\"", "\" precision=\"", "\"/>"});
    register("USC", new String[] {"<USC_Underscore page=\"", "\" x=\"", "\" y=\"",
        "\" bypassFlag=\"", "\"/>"});
    register("DIR", new String[] {"<DIR_DrawIaxisRule page=\"", "\" x=\"", "\" y=\"",
        "\" length=\"", "\"", "\"/>"});
    register("DBR", new String[] {"<DBR_DrawBaxisRule page=\"", "\" x=\"", "\" y=\"",
        "\" length=\"", "\"", "\"/>"});
    ...
    // PTOCA Control Sequences
    register("SEC", new String[] {"<SEC_SetExtendedTextColor page=\"", "\" x=\"", "\" y=\"",
        "\" colorSpace=\"", "\" nrOfBitsComponent1=\"", "\" nrOfBitsComponent2=\"",
        "\" nrOfBitsComponent3=\"", "\" nrOfBitsComponent4=\"", "\" colorValue=\"", "\"/>"});
  ...
  /**
   * Registers a new XML template.
   *
   * @param mnemonic the mnemonic identifier
   * @param parts the fragments of the XML template
   */
