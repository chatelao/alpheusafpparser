...
public class PdfFontRegistry {
  ...
  private PdfFont mapToStandardFont(String afpFontName, boolean boldHint, boolean italicHint) {
    ...
    if (familyPrefix.equals("C0H") || familyPrefix.equals("C0S")
        ...
        || (familyPrefix.equals("C0N") && isOutline)) {
      // Helvetica / Swiss / Arial / Univers / Gothic / Nimbus Sans (Outline)
      if (isBold && isItalic) {
        ...
        || familyPrefix.equals("C0T")
        || (familyPrefix.equals("C0N") && !isOutline)) { // Dutch / Times / Nimbus Sans (Raster)
      if (isBold && isItalic) {
