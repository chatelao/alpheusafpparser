...
public class PdfFontRegistry {
  ...
  private PdfFont mapToStandardFont(String afpFontName, boolean boldHint, boolean italicHint) {
    ...
    if (familyPrefix.equals("C0H") || familyPrefix.equals("C0S")
        ...
        || familyPrefix.equals("C0G") || familyPrefix.equals("C0N")) { // Helvetica / Swiss / Arial / Univers / Gothic / Neue Haas
      if (isBold && isItalic) {
    ...
    } else if (familyPrefix.equals("C0D") || familyPrefix.equals("C0T")) { // Dutch / Times
      if (isBold && isItalic) {
