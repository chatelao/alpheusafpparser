...
public class BCOCARoundTripTest {
    ...
    public void testBDDRoundTrip() throws Exception {
        ...
        byte[] data = new byte[] {
            ...
            0x00, 0x00, 0x05, (byte) 0xA0, 0x05, (byte) 0xA0, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00,
            0x01, 0x01, 0x00, 0x00, 0x00, 0x10, 0x00, 0x64, 0x01, 0x00, 0x00
        };
    ...
    public void testBDARoundTrip() throws Exception {
        ...
        byte[] data = new byte[] {
            ...
            (byte) 0x80, 0x00, 0x00, 0x00, 0x00, (byte) 0xF1, (byte) 0xF2, (byte) 0xF3
        };
