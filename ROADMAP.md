...
- 🚧 Migrate tests from JUnit 4 to JUnit 5 (Jupiter).
    ...
    - 🚧 Migrate remaining tests:
        - 🚧 MO:DCA Round Trip tests (2/8 migrated: ✅ DescriptorAndMap, ✅ PresentationControl, ⏳ DocumentAndPageGroup, ⏳ EnvironmentAndResourceGroup, ⏳ IndexAndTagging, ⏳ MediumControl, ⏳ ObjectAndData, ⏳ PageAndOverlay).
