...
| CMOCA-1-003 | Figure 1. Presentation Environment. The environment is a coordinated set of services architected ... | ✅ |
...
| CMOCA-1-021 | manage | ✅ |
| CMOCA-1-022 | finish | ✅ |
| CMOCA-1-023 | The ability to create, store, retrieve, view, and print data in presentation formats friendly to ... | ✅ |
| CMOCA-1-024 | The solution is a presentation architecture base that is both robust and open ended, and easily a... | ✅ |
| CMOCA-1-025 | AFP architectures define interchange formats that are system independent and are independent of a... | ✅ |
| CMOCA-1-026 | AFP architectures provide the means for representing documents in a data format that is independe... | ✅ |
| CMOCA-1-027 | The presentation architecture components are divided into two major categories: data streams and ... | ✅ |
| CMOCA-1-028 | A data stream is a continuous ordered stream of data elements and objects conforming to a given f... | ✅ |
...
| CMOCA-1-031 | The MO:DCA architecture defines the data stream used by applications to describe documents and ob... | ✅ |
| CMOCA-1-032 | The IPDS architecture defines the data stream used by print server programs and device drivers to... | ✅ |
| CMOCA-1-033 | Figure 2 shows a system model relating MO:DCA and IPDS data streams to the presentation environme... | ✅ |
| CMOCA-1-034 | Figure 2. Presentation Model. This diagram shows the major components in a presentation system an... | ✅ |
...
| CMOCA-1-048 | Documents can be made up of different kinds of data, such as text, graphics, image, and bar code.... | ✅ |
| CMOCA-1-049 | A data object contains a single type of presentation data, that is, presentation text, vector gra... | ✅ |
| CMOCA-1-050 | A resource object is a collection of presentation instructions and data. These objects are refere... | ✅ |
| CMOCA-1-051 | All object content architectures (OCAs) are totally self-describing and independently defined. Wh... | ✅ |
| CMOCA-1-052 | The AFPC-defined object content architectures are: | ✅ |
| CMOCA-1-053 | Presentation Text Object Content Architecture (PTOCA): A data architecture for describing text ob... | ✅ |
| CMOCA-1-054 | Image Object Content Architecture (IOCA): A data architecture for describing resolution-independe... | ✅ |
| CMOCA-1-055 | Graphics Object Content Architecture for Advanced Function Presentation (AFP GOCA): A version of ... | ✅ |
| CMOCA-1-056 | Bar Code Object Content Architecture (BCOCA): A data architecture for describing bar code objects... | ✅ |
| CMOCA-1-057 | Font Object Content Architecture (FOCA): A resource architecture for describing the structure and... | ✅ |
| CMOCA-1-058 | Color Management Object Content Architecture (CMOCA): A resource architecture used to carry the c... | ✅ |
| CMOCA-1-059 | Metadata Object Content Architecture (MOCA): A resource architecture used to carry metadata in an... | ✅ |
| CMOCA-1-060 | The MO:DCA and IPDS architectures also support data objects that are not defined by object conten... | ✅ |
| CMOCA-1-061 | In addition to object content architectures, the MO:DCA architecture defines envelope architectur... | ✅ |
| CMOCA-1-062 | Figure 3 shows an example of an all-points-addressable page composed of multiple presentation obj... | ✅ |
| CMOCA-1-063 | Figure 3. Presentation Page. This is an example of a mixed-object page that can be composed in a ... | ✅ |
| CMOCA-2-001 | The Color Management Object Content Architecture (CMOCA) defines objects that provide color manag... | ✅ |
| CMOCA-2-002 | Consistent output across different devices | ✅ |
| CMOCA-2-003 | Accurate output, to the best of the device capability, from a wide variety of inputs provided tha... | ✅ |
...
| CMOCA-2-006 | The architecture described in this document is defined in the terms of the AFP architectures to s... | ✅ |
| CMOCA-2-007 | The device that presents the data could be a printer, a display, or other system. This document f... | ✅ |
| CMOCA-2-008 | A Color Management Resource (CMR) is an architected resource that is used to carry the color mana... | ✅ |
...
| CMOCA-2-014 | Note: Not all CMR types are applicable for a particular kind of presentation device; for instance... | ✅ |
| CMOCA-2-015 | A CMR can reflect processing that has been done on an object, in which case it is referred to as ... | ✅ |
| CMOCA-2-016 | In AFP environments, CMRs are processed as AFP resources by print servers so they can be download... | ✅ |
...
| CMOCA-2-020 | To use a format that is flexible enough to allow it to exist intact in interactive, presentation,... | ✅ |
...
| CMOCA-2-026 | To use a naming convention for the CMRs that allow device-specific color resources to be substitu... | ✅ |
| CMOCA-2-027 | To define CMRs so that multiple CMRs can be invoked at one time, and a hierarchy can be searched ... | ✅ |
| CMOCA-2-028 | In AFP environments, CMRs will be carried within an object container. CMRs can be associated with... | ✅ |
...
| CMOCA-2-034 | Within the IPDS data stream, CMRs are activated and deactivated like all other IPDS resources but... | ✅ |
| CMOCA-3-001 | A CMR consists of a header followed by CMR data. | ✅ |
| CMOCA-3-002 | To start, for simplicity, assume that the source data is specified in a device-independent color ... | ✅ |
...
| CMOCA-3-007 | When color data has been processed using the above sequence, the resulting object can be stored i... | ✅ |
...
| CMOCA-3-013 | In actuality, halftoning is not typically undone. The halftoned version is typically not stored i... | ✅ |
| CMOCA-3-014 | Now, let's assume that the source data is specified in a device-dependent color space and it is d... | ✅ |
...
| CMOCA-3-021 | Information that relates to the creation of the source data is referred to as an audit CMR. It mi... | ✅ |
| CMOCA-3-022 | The above discussion assumes that the color was specified using a color space. It is also possibl... | ✅ |
| CMOCA-3-023 | There are seven basic uses of the CMR that must be considered: | ✅ |
| CMOCA-3-024 | 1.  Audit Halftone can be attached to an image that has been halftoned and indicates which halfto... | ✅ |
| CMOCA-3-025 | 2.  Audit Tone Transfer Curve indicates a one-dimensional conversion that was applied to the inpu... | ✅ |
| CMOCA-3-026 | 3.  Audit Color Conversion is used to convert from the input color space to a profile connection ... | ✅ |
| CMOCA-3-027 | 4.  Instruction Color Conversion is used to convert from the profile connection space to the colo... | ✅ |
| CMOCA-3-028 | 5.  Instruction Tone Transfer Curve is a one-dimensional conversion applied to the output color b... | ✅ |
| CMOCA-3-029 | 6.  Instruction Halftone is used to halftone the output colored data. | ✅ |
| CMOCA-3-030 | 7.  Link Color Conversion provides an efficient means for converting directly from the input colo... | ✅ |
| CMOCA-3-031 | When a presentation device is processing data using the CMR system, these are the basic steps tha... | ✅ |
| CMOCA-3-032 | 1.  The device ignores an Audit Halftone. It might be useful information to store with the image ... | ✅ |
| CMOCA-3-033 | 2.  The device applies an applicable Audit Tone Transfer Curve. If an inverse tone transfer curve... | ✅ |
| CMOCA-3-034 | 3.  If an applicable ICC DeviceLink exists, it is used. This link color conversion converts the i... | ✅ |
| CMOCA-3-035 | 4.  If an applicable Audit Color Conversion exists, it is used. This audit Color Conversion conve... | ✅ |
| CMOCA-3-036 | 5.  An Instruction Color Conversion is used to convert from the profile connection space into the... | ✅ |
...
| CMOCA-3-094 | 10   94–103   UTF16   Prop1   See description   CMRType property-specific field 1 | ✅ |
| CMOCA-3-095 | 12   104–115   UTF16   Prop2   See description   CMRType property-specific field 2 | ✅ |
| CMOCA-3-096 | 8   116–123   UTF16   Prop3   See description   CMRType property-specific field 3 | ✅ |
| CMOCA-3-097 | 8   124–131   UTF16   Prop4   See description   CMRType property-specific field 4 | ✅ |
| CMOCA-3-098 | 8   132–139   UTF16   Prop5   See description   CMRType property-specific field 5 | ✅ |
| CMOCA-3-099 | 16   140–155   UTF16   @@@@@@@@     Reserved | ✅ |
| CMOCA-3-100 | (CMR Name ends here. It is composed of bytes 10–155.) | ✅ |
| CMOCA-3-101 | 8   156–163     X'00...00'     Reserved; should be set to zero | ✅ |
| CMOCA-3-102 | Variable   164–end     CMRData   Any   Resource data | ✅ |
| CMOCA-3-103 | 1. M/O denotes a mandatory or optional field. | ✅ |
| CMOCA-3-104 | 2. UTF16 denotes UTF-16BE. | ✅ |
| CMOCA-3-105 | The length of the complete CMR, including the Length parameter. Length may be 164 (X'000000A4') b... | ✅ |
| CMOCA-3-106 | The signature of the CMR that allows it to be easily recognized. It will be three ASCII character... | ✅ |
| CMOCA-3-107 | Eight-character user-defined string to enable an easy way of identifying the CMR. | ✅ |
| CMOCA-3-108 | Five CMRTypes are defined in this Color Management Object Content Architecture. They are: Halfton... | ✅ |
| CMOCA-3-109 | The CMRVersion number consists of a major version number (an integer of 1–3 digits) and a minor v... | ✅ |
| CMOCA-3-110 | A value of “AFP .ddd” is used to specify a minor version number along with “AFP” to indicate that... | ✅ |
| CMOCA-3-111 | A value of “generic” (X'0067 0065 006E 0065 0072 0069 0063') in this field identifies a generic C... | ✅ |
| CMOCA-3-112 | A value of “pasthru” (X'0070 0061 0073 0074 0068 0072 0075') identifies a color space that should... | ✅ |
| CMOCA-3-113 | The value of the CMRVersion must be specified in the header. The CMRVersion tracks changes beside... | ✅ |
| CMOCA-3-114 | For IPDS receivers, the ManufacturerName, DeviceType, and DeviceModel values must be provided in ... | ✅ |
| CMOCA-3-115 | ManufacturerName: Name of the manufacturer. | ✅ |
| CMOCA-3-116 | DeviceType: Device type of the printer that corresponds to the device type imprinted on the seria... | ✅ |
| CMOCA-3-117 | DeviceModel: Model number of the printer that corresponds to the model number imprinted on the se... | ✅ |
| CMOCA-3-118 | For the non-IPDS devices, a maximum of five characters are allowed for the ManufacturerName. The ... | ✅ |
| CMOCA-3-119 | Implementation notes: | ✅ |
| CMOCA-3-120 | 1.  If the DeviceType is unspecified (@@@@@@), then it automatically matches the DeviceType of th... | ✅ |
...
| CMOCA-3-131 | Defines the halftone type. Halftone types are divided into four major categories: clustered-dot, ... | ✅ |
...
| CMOCA-3-152 | Defines the orientation of the halftone. There are three possible values: orientation independent... | ✅ |
...
| CMOCA-3-157 | Note: These fields are informational only. They are not checked for validity. Any value may be en... | ✅ |
| CMOCA-3-158 | Prop1: Profile/Device Class Signature | ✅ |
| CMOCA-3-159 | The definition of the Device Class Signature is consistent with the definition in the ICC header.... | ✅ |
...
| CMOCA-3-166 | Look-and-Feel produced in the output when this Tone Transfer Curve is applied. See Appendix B, “G... | ✅ |
...
| CMOCA-3-175 | Note: These fields are informational only. They are not checked for validity. Any value may be en... | ✅ |
...
| CMOCA-3-186 | It is consistent with the definition of the Color Space of Data in the ICC header. Table 10 shows... | ✅ |
...
| CMOCA-3-215 | Note: These fields are informational only. They are not checked for validity. Any value may be en... | ✅ |
...
| CMOCA-3-221 | Device-specific color space, a subset of the Color Space of Data defined in the ICC profile heade... | ✅ |
...
| CMOCA-3-241 | Note: These fields are informational only. They are not checked for validity. Any value may be en... | ✅ |
...
| CMOCA-3-247 | The content of the data is defined by the CMR type. The CMR data carries the color resource data.... | ✅ |
| CMOCA-3-248 | CMR data is optional for generic and passthrough CMRs. If CMR data is specified for a generic or ... | ✅ |
| CMOCA-3-249 | On encountering an error, an exception is raised. Exception conditions have a format of EC-xxxxyy... | ✅ |
...
| CMOCA-4-008 | In the following descriptions, the Optional Tags and Mandatory Tags are listed to show which tags... | ✅ |
| CMOCA-4-009 | CMR Type HT (X'0048 0054') | ✅ |
| CMOCA-4-010 | Halftone can be classified into two types: point-operation halftone and neighborhood-operation ha... | ✅ |
| CMOCA-4-011 | Mandatory Tags: Halftone Subset, Array Width, Array Height, Bilevel Point-Operation Screen Data, ... | ✅ |
| CMOCA-4-012 | Optional Tags: Comment, Date and Time Stamp, Number of Components, Offset Tiling | ✅ |
| CMOCA-4-013 | Mandatory Tags: Halftone Subset, Array Width, Array Height, Max Image Value, Number of Device Lev... | ✅ |
| CMOCA-4-014 | Optional Tags: Comment, Date and Time Stamp, Number of Components, Offset Tiling | ✅ |
| CMOCA-4-015 | Mandatory Tags: Halftone Subset, Array Width, Array Height, Error Diffusion Filter, Location of C... | ✅ |
| CMOCA-4-016 | Optional Tags: Comment, Date and Time Stamp, Number of Components | ✅ |
| CMOCA-4-017 | Mandatory Tags: Halftone Subset, Array Width, Array Height, Number of Device Levels, Error Diffus... | ✅ |
| CMOCA-4-018 | Optional Tags: Comment, Date and Time Stamp, Number of Components | ✅ |
| CMOCA-4-019 | CMR Type TC (X'0054 0043') | ✅ |
| CMOCA-4-020 | Tone transfer curves are applied to data prior to halftoning or output. The inverse tone transfer... | ✅ |
| CMOCA-4-021 | Mandatory Tags: Tone Transfer Curve Subset, Tone Transfer Curve Data, End Data | ✅ |
| CMOCA-4-022 | Optional Tags: Comment, Date and Time Stamp, Number of Components, Tone Transfer Curve Length, In... | ✅ |
| CMOCA-4-023 | The tone transfer curve for each component is the identity. No data is sent with this subset, tha... | ✅ |
...
| CMOCA-4-027 | Each instance of this CMR type is a subset of the standard ICC profile. This allows the CMR to be... | ✅ |
| CMOCA-4-028 | The ICC Profile Data starts with a 128-byte header followed by the ICCTags. The ICCHeaderFields a... | ✅ |
| CMOCA-4-029 | Each subset of the ICC profile type, selected by the ICC Profile Subset tag, defines a subset of ... | ✅ |
| CMOCA-4-030 | Note: The chromaticAdaptationTag is shown as optional for each subset. However, it is mandatory i... | ✅ |
| CMOCA-4-031 | Two ICCHeaderFields are mandatory for the Color Conversion CMR: Color Space of Data and Profile C... | ✅ |
| CMOCA-4-032 | Color Space of Data: The ICC-supported color spaces and their signatures are listed in Table 10. | ✅ |
| CMOCA-4-033 | Profile Connection Space: The ICC profile connection space is either CIELAB D50 or CIEXYZ D50 for... | ✅ |
| CMOCA-4-034 | The currently allowed ICC profile subsets for Color Conversion CMRs include all the ICC profile t... | ✅ |
...
| CMOCA-4-045 | The Basic Intents Column describes the most commonly used color conversion direction(s) for each ... | ✅ |
...
| CMOCA-4-048 | Implementation note: It is very important to include the ICC Profile Filename tag for debugging p... | ✅ |
...
| CMOCA-4-054 | Optional ICCTags: chromaticAdaptationTag, AT oB0Tag, AT oB1Tag, AT oB2Tag, BT oA0Tag, BT oA1Tag, ... | ✅ |
...
| CMOCA-4-060 | Optional ICCTags: chromaticAdaptationTag, AT oB0Tag, AT oB1Tag, AT oB2Tag, BT oA0Tag, BT oA1Tag, ... | ✅ |
...
| CMOCA-4-066 | Optional ICCTags: chromaticAdaptationTag, AT oB0Tag, AT oB1Tag, AT oB2Tag, BT oA0Tag, BT oA1Tag, ... | ✅ |
...
| CMOCA-4-071 | Mandatory ICCTags: profileDescriptionTag, redMatrixColumnTag, greenMatrixColumnTag, blueMatrixCol... | ✅ |
| CMOCA-4-072 | Optional ICCTags: chromaticAdaptationTag, AT oB0Tag, AT oB1Tag, AT oB2Tag, BT oA0Tag, BT oA1Tag, ... | ✅ |
...
| CMOCA-4-077 | Mandatory ICCTags: profileDescriptionTag, redMatrixColumnTag, greenMatrixColumnTag, blueMatrixCol... | ✅ |
| CMOCA-4-078 | Optional ICCTags: chromaticAdaptationTag, AT oB0Tag, AT oB1Tag, AT oB2Tag, BT oA0Tag, BT oA1Tag, ... | ✅ |
...
| CMOCA-4-084 | Optional ICCTags: chromaticAdaptationTag, AT oB1Tag, AT oB2Tag, BT oA0Tag, BT oA1Tag, BT oA2Tag, ... | ✅ |
...
| CMOCA-4-095 | Mandatory ICCTags: profileDescriptionTag, AT oB0Tag, BT oA0Tag, AT oB1Tag, BT oA1Tag, AT oB2Tag, ... | ✅ |
...
| CMOCA-4-105 | The purpose of the Link Color Conversion CMR is to convert directly from the input to the output ... | ✅ |
| CMOCA-4-106 | Link Color Conversion with up to four Lookup Tables (LUTs) representing different rendering inten... | ✅ |
| CMOCA-4-107 | ICC DeviceLink contains an ICC profile of type DeviceLink. It contains a complex color conversion... | ✅ |
| CMOCA-4-108 | LinkColorConversion LUT subset: Its purpose is to combine an audit Color Conversion CMR with an i... | ✅ |
| CMOCA-4-109 | ICC DeviceLink subset: Its purpose is to provide a customized path to convert directly from input... | ✅ |
| CMOCA-4-110 | Currently, three Link Color Conversion subsets are defined. Table 22 lists the Link Color Convers... | ✅ |
| CMOCA-4-111 | X'01'   LinkColorConversion LUT   Connection between two device color spaces, or the connection b... | ✅ |
| CMOCA-4-112 | X'02'   LinkColorConversion Identity   No conversion needed. Selected based on OIDs of selected a... | ✅ |
| CMOCA-4-113 | X'03'   ICC DeviceLink   Direct conversion between input and output space without reference to au... | ✅ |
| CMOCA-4-114 | Mandatory Tags: Link Color Conversion Subset, Link Audit CMR OID, Link Instruction CMR OID, Link ... | ✅ |
| CMOCA-4-115 | Optional Tags: Comment, Date and Time Stamp, Link LUT Media-Relative Colorimetric, Link LUT Satur... | ✅ |
| CMOCA-4-116 | This subset is used when the input space is the same as the device's output space and no color co... | ✅ |
| CMOCA-4-117 | Mandatory Tags: Link Color Conversion Subset, Link Audit CMR OID, Link Instruction CMR OID, Link ... | ✅ |
...
| CMOCA-4-121 | Mandatory ICCTags: profileDescriptionTag, copyrightTag, profileSequenceDescTag, AtoB0Tag, coloran... | ✅ |
| CMOCA-4-122 | Optional ICCTags: None | ✅ |
| CMOCA-4-123 | CMR Type IX (X'0049 0058') | ✅ |
| CMOCA-4-124 | An Indexed CMR contains one or more Color Palette tags that translate 2-byte indexed color values... | ✅ |
...
| CMOCA-4-132 | If no Color Palette tag is specified, exception condition EC-50400E exists. It is shown in “Color... | ✅ |
| CMOCA-4-133 | EC-50400E Missing Required Tag: At least one Color Palette tag is required but none were specified. | ✅ |
| CMOCA-5-001 | The CMR Data field carries all the actual color resource data. The resource data is carried in a ... | ✅ |
...
| CMOCA-5-016 | Tags X'F000'–X'FFFE' are private tags. Organizations may use a private tag in this range for thei... | ✅ |
| CMOCA-5-017 | X'EF00'–X'EFFF' are reserved for error handling for the CMR header. | ✅ |
| CMOCA-5-018 | The tags in a CMR must be specified in increasing order by their TagIDs. If they are out of order... | ✅ |
| CMOCA-5-019 | There is no restriction on where the actual data fields are located, as long as they are within t... | ✅ |
| CMOCA-5-020 | The number of bytes of data for a tag is the value of Count multiplied by the size of each data i... | ✅ |
| CMOCA-5-021 | Each type of CMR has a list of Mandatory Tags and a list of optional tags. The receivers should i... | ✅ |
| CMOCA-5-022 | On encountering an error, an exception is raised. Each exception is defined by a three byte value... | ✅ |
...
| CMOCA-5-028 | X'10'   Invalid or unsupported field value or an offset that causes the tag data to start or end ... | ✅ |
...
| CMOCA-5-032 | The CMR coordinate system is a two dimensional Cartesian coordinate system. The horizontal axis i... | ✅ |
...
| CMOCA-5-055 | YearAD: Specifies the year AD using the Gregorian calendar. For example, the year 1999 is specifi... | ✅ |
...
| CMOCA-6-005 | The actual input and output device color spaces constrain which CMRs are applicable. There can be... | ✅ |
| CMOCA-6-006 | Further, CMRs can be invoked at multiple levels of the AFP document hierarchy and it is possible ... | ✅ |
| CMOCA-6-007 | Media matching also affects the hierarchical search. If the media attributes specified in the CMR... | ✅ |
| CMOCA-6-008 | Note that there might be multiple CMRs of a given type invoked at one particular level. For insta... | ✅ |
| CMOCA-6-009 | Taken as a whole, the CMR system can seem complex. But a typical situation will be simple. Some c... | ✅ |
| CMOCA-6-010 | When a CMR is needed, the device searches the hierarchy for an applicable CMR that applies to the... | ✅ |
| CMOCA-6-011 | 1.  CMR invoked with an object. Note that CMRs attached to an object received in home state are i... | ✅ |
| CMOCA-6-012 | 2.  CMR invoked with a page or overlay | ✅ |
| CMOCA-6-013 | 3.  CMR invoked in home state | ✅ |
| CMOCA-6-014 | 4.  Device default CMR | ✅ |
| CMOCA-6-015 | If two applicable CMRs that both apply to the current color space are invoked at the same level, ... | ✅ |
| CMOCA-6-016 | For color conversions, link CMRs are normally used to improve throughput. The following discussio... | ✅ |
| CMOCA-6-017 | 1.  Presentation data specifies an input color space. Knowing that color space, a search is done ... | ✅ |
| CMOCA-6-018 | 2.  Next, knowing the input color space, a search is done of the invoked audit Color Conversion C... | ✅ |
| CMOCA-6-019 | 3.  A search of the invoked instruction Color Conversion CMRs is done to find the first one with ... | ✅ |
| CMOCA-6-020 | 4.  A search is done of the invoked instruction Tone Transfer Curve CMRs to find one with the cor... | ✅ |
| CMOCA-6-021 | 5.  A search is done of the invoked Halftone CMRs to find one with the right number of components. | ✅ |
| CMOCA-6-022 | 6.  The colored data is converted and halftoned using these CMRs. Note that it is possible to com... | ✅ |
| CMOCA-6-023 | CMRs must be applicable in order to be used. If a CMR is not applicable, it may be ignored and no... | ✅ |
| CMOCA-6-024 | An instruction Tone Transfer Curve CMR with three components is not applicable if the device is m... | ✅ |
| CMOCA-6-025 | An instruction Halftone CMR with three components is not applicable on a CMYK device. | ✅ |
| CMOCA-6-026 | An audit Color Conversion CMR that converts from a three-component space is not applicable if the... | ✅ |
| CMOCA-6-027 | An output Color Conversion CMR that converts into a four-component color space is not applicable ... | ✅ |
| CMOCA-6-028 | In order to select a CMR, the hierarchy is searched as discussed above, looking for an applicable... | ✅ |
| CMOCA-6-029 | Link Color Conversion CMRs provide an efficient method for converting directly from the input col... | ✅ |
...
| CMOCA-6-032 | When Color Conversion CMRs are sent to the device, an OID must be attached. The OID uniquely iden... | ✅ |
| CMOCA-6-033 | The audit and instruction CMRs are identified as described above. Then a search is done of Link C... | ✅ |
| CMOCA-6-034 | Note, further, that an audit CMR must be identified to use a downloaded link CMR. If the audit-ty... | ✅ |
| CMOCA-6-035 | Link Color Conversion CMRs also require tags containing the CMR names of the audit and instructio... | ✅ |
| CMOCA-6-036 | In some situations, it might be desirable to use a conversion that goes direct from input color s... | ✅ |
| CMOCA-6-037 | A link CMR with subset type of ICC DeviceLink must be invoked in order to be used. Note that othe... | ✅ |
| CMOCA-6-038 | This special link CMR has precedence over audit/instruction color conversions. In the following, ... | ✅ |
| CMOCA-6-039 | The existence of an audit CC at some level has precedence over an ICC DeviceLink at a lower level... | ✅ |
| CMOCA-6-040 | Search at the object level | ✅ |
| CMOCA-6-041 | Look for an ICC DeviceLink. If found, stop and use it. | ✅ |
| CMOCA-6-042 | Else look for an audit CC CMR. If found, stop, find an instruction CC CMR by searching all levels... | ✅ |
| CMOCA-6-043 | If an ICC Profile exists within the object (e.g., TIFF), use it and find an instruction CC CMR by... | ✅ |
| CMOCA-6-044 | Else search at the page/overlay level | ✅ |
| CMOCA-6-045 | Look for an ICC DeviceLink. If found, stop and use it. | ✅ |
| CMOCA-6-046 | Else look for an audit CC CMR. If found, stop, find an instruction CC CMR by searching all levels... | ✅ |
| CMOCA-6-047 | Else search at higher levels | ✅ |
| CMOCA-6-048 | Look for an ICC DeviceLink. If found, stop and use it. | ✅ |
| CMOCA-6-049 | Else look for an audit CC CMR. If found, stop, find an instruction CC CMR by searching all levels... | ✅ |
...
| CMOCA-6-054 | An audit Color Conversion CMR describes device-dependent colors or non-device colors (for example... | ✅ |
...
| CMOCA-6-057 | If the device is an RGB display, it requires color conversions that convert into the RGB of the d... | ✅ |
| CMOCA-6-058 | The device may ignore any instruction CMRs that are not applicable, thus making the search path s... | ✅ |
| CMOCA-6-059 | Table 49 shows which ICC profiles may be used for audit CMRs and which may be used for instructio... | ✅ |
...
| CMOCA-6-069 | Input type profiles describe colors coming from a scanner or digital camera and therefore they ar... | ✅ |
| CMOCA-6-070 | A link CMR describes how to convert directly from an input color space to an output device color ... | ✅ |
| CMOCA-6-071 | The link creation process combines the audit and instruction CMRs and creates four LUTs. Each LUT... | ✅ |
| CMOCA-6-072 | To create each link LUT, the appropriate color conversion based on rendering intent must be selec... | ✅ |
...
| CMOCA-6-075 | 3.  The color conversion corresponding to that rendering intent is selected from the instruction ... | ✅ |
| CMOCA-6-076 | 4.  The selected audit and instruction color conversions are combined to produce the link LUT for... | ✅ |
| CMOCA-6-077 | The selection is based on the rendering intent of the link LUT currently being created and the go... | ✅ |
| CMOCA-6-078 | When the color conversion rule for one of the rendering intents is not available, another color c... | ✅ |
| CMOCA-6-079 | The basic rules for selecting a color conversion that corresponds to a given rendering intent for... | ✅ |
| CMOCA-6-080 | 1.  If the appropriate AToBxTag (or BToAxTag) for that rendering intent exists, it is used. (AToB... | ✅ |
| CMOCA-6-081 | 2.  If that tag does not exist, the rendering intent in the header of this ICC profile is noted. ... | ✅ |
...
| CMOCA-6-084 | For three-component matrix-based profiles, the matrix/TRC combinations are used for all rendering... | ✅ |
| CMOCA-6-085 | For monochrome profiles, the inverse of the grayTRCTag is used for all rendering intents. | ✅ |
| CMOCA-6-086 | For three-component matrix-based profiles, the inverse of the matrix/TRC transformation, as descr... | ✅ |
| CMOCA-6-087 | From the audit CMR, use the same tag(s) as were used when creating the link LUT for media-relativ... | ✅ |
| CMOCA-6-088 | From the instruction CMR, use the same tag(s) as were used when creating the link LUT for media-r... | ✅ |
...
| CMOCA-6-092 | The second step, modifying the color for each plane, is typically a one-dimensional conversion an... | ✅ |
| CMOCA-6-093 | There must be some way to put the device into a well-known state and maintain it in that state. T... | ✅ |
| CMOCA-6-094 | The user might want to control the look-and-feel of the output. | ✅ |
| CMOCA-6-095 | Each device may handle these processes in different ways, but the following describes one way of ... | ✅ |
| CMOCA-6-096 | Tone Transfer Curve (TTC): This curve is contained in a CMR and can be specified by the user to m... | ✅ |
| CMOCA-6-097 | Operator Requested Curve: This curve allows the user the same control of the look-and-feel of the... | ✅ |
| CMOCA-6-098 | Tone Reproduction Curve: This curve is used to put the printer into a known state. It compensates... | ✅ |
| CMOCA-6-099 | Calibration Curve: This curve is used to modify the behavior of a device, returning it to a known... | ✅ |
| CMOCA-6-100 | The Tone Transfer Curve (TTC) and the Operator Requested Curve perform essentially the same funct... | ✅ |
| CMOCA-6-101 | Note that the above discussion assumes that the printer calibration is done digitally, in softwar... | ✅ |
| CMOCA-6-102 | Indexed CMRs provide rules about how to render indexed colors. Indexed CMRs apply to indexed colo... | ✅ |
| CMOCA-6-103 | For Indexed CMRs, both instruction and audit processing modes are valid. However, only Indexed CM... | ✅ |
| CMOCA-6-104 | The tags in the Indexed CMR allow the CMR to use various color spaces in the descriptions. These ... | ✅ |
| CMOCA-6-105 | If the color palette is given in terms of named colorants, and some of the colorants required to ... | ✅ |
| CMOCA-6-106 | 1.  The output color space of the device (typically CMYK for printers and RGB for displays) | ✅ |
| CMOCA-6-107 | 2.  A named colorant space, which could include spot colors that are available in the printer and... | ✅ |
| CMOCA-6-108 | In the first case, the Tone Transfer Curve CMR and the Halftone CMR selected from the hierarchy f... | ✅ |
| CMOCA-6-109 | The Indexed CMR to be used is selected using the normal hierarchical rules. Media-matching rules ... | ✅ |
...
| CMOCA-6-112 | There are three possible processing modes: audit, instruction, and link. Only certain processing ... | ✅ |
| CMOCA-6-113 | A CMR is generic if the CMRVersion in the CMR Header is “generic”. Only Tone Transfer Curve CMRs ... | ✅ |
| CMOCA-6-114 | Color Conversion   valid   valid   invalid - error   invalid - error   invalid - error   invalid ... | ✅ |
...
| CMOCA-6-117 | Link Color Conversion   invalid - error   invalid - error   valid   invalid - error   invalid - e... | ✅ |
| CMOCA-6-118 | Indexed   valid - ignored   valid   invalid - error   invalid - error   invalid - error   invalid... | ✅ |
| CMOCA-6-119 | 1. Generic Tone Transfer Curves and generic Halftones are ignored because, in order to replace a ... | ✅ |
| CMOCA-6-121 | Every device must supply both audit and instruction default CMRs. | ✅ |
| CMOCA-6-122 | The required default instruction CMRs are used to process colors in the color space of the device... | ✅ |
| CMOCA-6-123 | For optimum quality, the device should have default instruction CMRs that are tuned for each type... | ✅ |
| CMOCA-6-124 | In some cases, a printer controller might be ripping pages that are sent to one of several print ... | ✅ |
| CMOCA-6-125 | The default Halftone and Tone Transfer Curve CMRs might also differ depending on the media or eng... | ✅ |
...
| CMOCA-6-128 | An instruction Color Conversion CMR from an ICC Profile Connection Space (CIEXYZ or CIELAB) to th... | ✅ |
| CMOCA-6-129 | There are no default Indexed CMRs. | ✅ |
| CMOCA-6-130 | The default instruction Color Conversion CMRs can be used when constructing Link Color Conversion... | ✅ |
| CMOCA-6-131 | Note that printer default CMRs are used only when no other applicable CMR is invoked in the hiera... | ✅ |
| CMOCA-6-132 | To force the printer to choose an applicable default instruction CMR, no applicable CMR of that t... | ✅ |
| CMOCA-6-133 | Audit CMRs are not dependent on the output device or the media, so only one default in each categ... | ✅ |
| CMOCA-6-134 | An audit Color Conversion CMR from input RGB to CIEXYZ or CIELAB. (A display may assume that the ... | ✅ |
| CMOCA-6-135 | An audit Color Conversion CMR from input CMYK to CIEXYZ or CIELAB. (A full-color printer may assu... | ✅ |
...
| CMOCA-6-139 | If any other color spaces such as Luv, HSV, HLS, Yxy, or CMY are used within the data stream, the... | ✅ |
...
| CMOCA-6-142 | CMYK: In an AFP full-color printer, this represents the CMYK of the presentation device. In an AF... | ✅ |
| CMOCA-6-143 | Grayscale: The Grayscale default applies when the color space has one component and more than 1 b... | ✅ |
| CMOCA-6-144 | YCbCr or YCrCb: The default YCbCr is based on CCIR Recommendation 601-1 but components are normal... | ✅ |
...
| CMOCA-6-149 | Instruction Halftone CMRs and instruction Tone Transfer Curve CMRs can be generic. Generic CMRs m... | ✅ |
| CMOCA-6-150 | An audit Color Conversion CMR can specify the version to be “pasthru”. Passthrough CMRs are defin... | ✅ |
| CMOCA-6-151 | The CMRVersion in the CMR header indicates whether a CMR is passthrough. Prop4 in the header indi... | ✅ |
| CMOCA-6-152 | A passthrough CC CMR is treated like other audit CC CMRs in terms of selecting an audit CC CMR fr... | ✅ |
| CMOCA-6-153 | If the target device is a display screen and the MediaBrightness is not specified or is not a val... | ✅ |
| CMOCA-6-154 | If the target device is a printer and one or more of the four media fields in the header are not ... | ✅ |
...
| CMOCA-6-163 | When presentation data objects contain internal color management information, the device will use... | ✅ |
...
| CMOCA-6-173 | If an instruction Color Conversion CMR is associated directly with the EPS/PDF object, it will ov... | ✅ |
| CMOCA-6-174 | Link Color Conversion CMRs should be used when processing EPS/PDF if a device reports support for... | ✅ |
| CMOCA-6-175 | If a halftone is specified within the EPS/PDF object, it will be used instead of the default EPS/... | ✅ |
| CMOCA-6-176 | If an instruction Halftone CMR is associated directly with the EPS/PDF object, it will override b... | ✅ |
| CMOCA-6-177 | If a Transfer Function is specified within the EPS/PDF object, it will be used. | ✅ |
| CMOCA-6-178 | If an instruction Tone Transfer Curve CMR is associated directly with the EPS/PDF object, it will... | ✅ |
| CMOCA-6-179 | Some devices cannot completely, reliably ensure that a selected CMR is actually applied. This is ... | ✅ |
...
| CMOCA-6-188 | A CMR is passthrough if the CMRVersion in the CMR Header is “pasthru”. | ✅ |
| CMOCA-6-189 | Only Color Conversions may be passthrough so, if the CMR type is anything else, an exception occurs. | ✅ |
| CMOCA-6-190 | The mode of a passthrough CC CMR must be audit. | ✅ |
| CMOCA-6-191 | The CMR is ignored if the mode is specified as instruction. | ✅ |
| CMOCA-6-192 | If the mode is link, an exception is generated since that is not valid for any Color Conversion C... | ✅ |
...
| CMOCA-B-002 | No device or media information may be included in generic names. Only the fields describing the g... | ✅ |
| CMOCA-B-003 | The CMR names specified in Figure 12 and Figure 13 are the only valid generic CMRs. | ✅ |
| CMOCA-B-004 | The registered generic Halftone CMRs are shown in Figure 12. Halftone Property 3 (Line Screen Fre... | ✅ |
| CMOCA-B-005 | Figure 12. Generic Halftone CMRs | ✅ |
| CMOCA-B-006 | The first eleven generic Halftone CMRs are used for clustered-dot halftones and indicate the line... | ✅ |
...
| CMOCA-B-011 | A Tone Transfer Curve (color calibration) alters the darkness of image data, accounting for the d... | ✅ |
| CMOCA-B-012 | The actual appearance depends on a combination of the printer model, the halftone screen, and the... | ✅ |
| CMOCA-B-013 | Standard: Exactly undoing the dot gain of the printer. | ✅ |
| CMOCA-B-014 | Dark, Accutone, Highlight Midtone, Standard: Have dot gains of 33, 22, 14, and 0 percent respecti... | ✅ |
| CMOCA-B-015 | The tone transfer curve (TTC) and halftone are interrelated. The TTC depends on the halftone that... | ✅ |
| CMOCA-B-016 | A device-specific TTC would specify both the Look-and-Feel and the Halftone Characterization. | ✅ |
| CMOCA-B-017 | If the printer has device-specific halftones at 75, 104, and 141 lpi, it would need to have 12 de... | ✅ |
| CMOCA-C-001 | In order to claim that the baseline Color Management Object Content Architecture is supported, a ... | ✅ |
...
| CMOCA-C-007 | In order to claim that the baseline Color Management Object Content Architecture is supported, a ... | ✅ |
| CMOCA-C-008 | The AFP Consortium or consortium member companies might have patents or pending patent applicatio... | ✅ |
| CMOCA-C-009 | AFP Consortium PROVIDES THIS PUBLICATION “AS IS” WITHOUT WARRANTY OF ANY KIND, EITHER EXPRESS OR ... | ✅ |
| CMOCA-C-010 | This publication could include technical inaccuracies or typographical errors. Changes are period... | ✅ |
| CMOCA-C-011 | These terms are trademarks or registered trademarks of Adobe Systems Incorporated: Acrobat, Adobe... | ✅ |
| CMOCA-C-012 | These terms are trademarks of the AFP Consortium: AFPC, AFP Consortium. | ✅ |
| CMOCA-C-013 | IBM and InfoPrint are trademarks of International Business Machines Corporation. PANTONE is a reg... | ✅ |
...
| CMOCA-C-016 | big endian: A format for storage or transmission of binary data in which the most significant bit... | ✅ |
| CMOCA-C-017 | CIELAB color space: Internationally accepted color space model used as a standard to define color... | ✅ |
| CMOCA-C-018 | color conversion: The process of converting colors from one color space to another. | ✅ |
| CMOCA-C-019 | instruction CMR: A color management resource that identifies processing that is to be done to an ... | ✅ |
