...
| CMOCA-6-040 | 1.  Search at the object level | ❓ |
...
| CMOCA-6-043 | 2.  If an ICC Profile exists within the object (e.g., TIFF), use it and find an instruction CC CM... | ❓ |
| CMOCA-6-044 | 3.  Else search at the page/overlay level | ❓ |
...
| CMOCA-6-047 | 4.  Else search at higher levels | ❓ |
...
| CMOCA-6-050 | 5.  Else use the default audit CC CMR | ❓ |
...
| CMOCA-6-080 | 1.  If the appropriate AT oBxTag (or BT oAxTag) for that rendering intent exists, it is used. (AT... | ❓ |
...
| CMOCA-6-120 | A CMR is passthrough if the CMRVersion in the CMR Header is “pasthru”. Only Color Conversions may... | ❓ |
