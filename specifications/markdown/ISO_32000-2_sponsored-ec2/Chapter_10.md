...
(DeviceGray, DeviceRGB, or DeviceCMYK), and thus implicitly remap device colour spaces into CIEbased colour spaces, when those device colour spaces do not match that of the raster output device. If
