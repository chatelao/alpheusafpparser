...
NOTE         The proper mechanism by which a file can identify itself as being a PDF file of a given version
...
With the exception of linearized PDF files, all PDF files should be read using the trailer and crossreference table as described in 7.5, "File structure". Linearized files should be read as specified in
...
NOTE         The subset standards for PDF, such as PDF/X (ISO 15930), PDF/A (ISO 19005), PDF/E (ISO
