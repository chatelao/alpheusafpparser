...
ISO 32000-2:2020(E)
388 © ISO 2020 – All rights reserved
...
ISO 32000-2:2020(E)
© ISO 2020 – All rights reserved 389
...
backdrop. In the lower two figures, the three objects are combined as a trans parency group. At the lower
...
a whole is painted against the backdrop with an opaci ty of 1.0 but in a different blend mode ( HardLight),
...
ISO 32000-2:2020(E)
390 © ISO 2020 – All rights reserved
...
ISO 32000-2:2020(E)
© ISO 2020 – All rights reserved 391
Variable Meaning
...
ISO 32000-2:2020(E)
392 © ISO 2020 – All rights reserved
11.3.5 Blend mode
11.3.5.1 General
...
ISO 32000-2:2020(E)
© ISO 2020 – All rights reserved 393
...
ISO 32000-2:2020(E)
394 © ISO 2020 – All rights reserved
...
ISO 32000-2:2020(E)
© ISO 2020 – All rights reserved 395
Name Result
ColorDodge
𝐵(𝑐𝑏, 𝑐𝑠)= {
0 if 𝑐𝑏 = 0
...
HardLight 𝐵(𝑐𝑏, 𝑐𝑠)= {Multiply(𝑐𝑏, 2 × 𝑐𝑠) if 𝑐𝑠 ≤ 0.5
...
ISO 32000-2:2020(E)
396 © ISO 2020 – All rights reserved
Name Result
...
ISO 32000-2:2020(E)
© ISO 2020 – All rights reserved 397
return ClipColor(𝐶)
...
ISO 32000-2:2020(E)
398 © ISO 2020 – All rights reserved
...
ISO 32000-2:2020(E)
© ISO 2020 – All rights reserved 399
...
ISO 32000-2:2020(E)
400 © ISO 2020 – All rights reserved
...
ISO 32000-2:2020(E)
© ISO 2020 – All rights reserved 401
Variable Meaning
𝒒𝒎 Mask opacity
𝒒𝒌 Constant opacity
...
ISO 32000-2:2020(E)
402 © ISO 2020 – All rights reserved
...
ISO 32000-2:2020(E)
© ISO 2020 – All rights reserved 403
...
ISO 32000-2:2020(E)
404 © ISO 2020 – All rights reserved
...
ISO 32000-2:2020(E)
© ISO 2020 – All rights reserved 405
...
ISO 32000-2:2020(E)
406 © ISO 2020 – All rights reserved
Variable Meaning
...
𝑓 Computed shape of the group, which shall be used as the object shape when
...
⟨𝐶𝑠𝑖, 𝑓𝑗𝑖, 𝛼𝑗𝑖⟩ = {Composite(𝐶𝑖−1, 𝛼𝑖−1, 𝐸𝑖) if 𝐸𝑖 is a group
...
ISO 32000-2:2020(E)
© ISO 2020 – All rights reserved 407
...
ISO 32000-2:2020(E)
408 © ISO 2020 – All rights reserved
...
group’s backdrop.
EXAMPLE Applying the Multiply blend mode to an obje ct in the group produces a darkening effect on other objects
 Sold by the PDF Association to Olivier Chatelain  19713 | May 26, 2026 |
 Single user only, copying and networking prohibited.
...
ISO 32000-2:2020(E)
© ISO 2020 – All rights reserved 409
...
ISO 32000-2:2020(E)
410 © ISO 2020 – All rights reserved
...
ISO 32000-2:2020(E)
© ISO 2020 – All rights reserved 411
...
ISO 32000-2:2020(E)
412 © ISO 2020 – All rights reserved
...
𝑈 An undefined colour (which is not used, since the α 0 argument of Composite is 0)
...
ISO 32000-2:2020(E)
© ISO 2020 – All rights reserved 413
...
⟨Csi,𝑓𝑗𝑖,αji⟩= {Composite(Cb,αb,Ei)                                                           if Ei is a group
...
ISO 32000-2:2020(E)
414 © ISO 2020 – All rights reserved
11.5 Soft masks
11.5.1 General
...
ISO 32000-2:2020(E)
© ISO 2020 – All rights reserved 415
...
ISO 32000-2:2020(E)
416 © ISO 2020 – All rights reserved
...
ISO 32000-2:2020(E)
© ISO 2020 – All rights reserved 417
...
ISO 32000-2:2020(E)
418 © ISO 2020 – All rights reserved
...
ISO 32000-2:2020(E)
© ISO 2020 – All rights reserved 419
...
function that shall be used in deriving the mask values. The function shall a ccept
...
ISO 32000-2:2020(E)
420 © ISO 2020 – All rights reserved
...
ISO 32000-2:2020(E)
© ISO 2020 – All rights reserved 421
Key Restriction
...
ISO 32000-2:2020(E)
422 © ISO 2020 – All rights reserved
...
Key Type Value
S name (Required) The group subtype, which identifies the type of group whose attributes this
...
ISO 32000-2:2020(E)
© ISO 2020 – All rights reserved 423
...
ISO 32000-2:2020(E)
424 © ISO 2020 – All rights reserved
...
ISO 32000-2:2020(E)
© ISO 2020 – All rights reserved 425
...
ISO 32000-2:2020(E)
426 © ISO 2020 – All rights reserved
...
ISO 32000-2:2020(E)
© ISO 2020 – All rights reserved 427
...
ISO 32000-2:2020(E)
428 © ISO 2020 – All rights reserved
...
ISO 32000-2:2020(E)
© ISO 2020 – All rights reserved 429
...
ISO 32000-2:2020(E)
430 © ISO 2020 – All rights reserved
...
colour components and 𝐶𝑏 for spot components. On the other hand, if the cu rrent colour space is a
...
ISO 32000-2:2020(E)
© ISO 2020 – All rights reserved 431
...
means that the ove rprint parameter in the graphics state is true and the overprint mode is 1. In the upper
...
ISO 32000-2:2020(E)
432 © ISO 2020 – All rights reserved
...
ISO 32000-2:2020(E)
© ISO 2020 – All rights reserved 433
Source colour
space
Affected colour
component of group
...
ISO 32000-2:2020(E)
434 © ISO 2020 – All rights reserved
...
ISO 32000-2:2020(E)
© ISO 2020 – All rights reserved 435
...
ISO 32000-2:2020(E)
436 © ISO 2020 – All rights reserved
