...
This updated sponsored release of ISO 32000-2 incorporates industry-resolved errata as of July
20, 2024, including errata resolutions that will be included in ISO 32000-2:2020/Amd1.

The majority of errata resolutions are provided as PDF annotations with respective comments
(including “sticky notes”, strike-throughs, caret insertions, and other track-changes markup). If
these annotations are not visible, use a more capable PDF viewer.

Annotations having a “Status” of “Completed” have been approved by ISO TC 171 SC 2 WG 8.
Those that have a “Status” of “Accepted” are approved by the PDF Association’s PDF Technical
Working Group (TWG). Depending on the viewer used this status information may be displayed
differently.
Resolutions include references to one or more respective GitHub issue numbers at
https://github.com/pdf-association/pdf-issues/issues/.

Some resolutions cannot be effectively represented via inline markup. In these cases, new pages
have been added to the end of the document. Navigation buttons are provided to simplify
access.

Additional new resolutions for this document may also be found at https://pdfissues.pdfa.org/32000-2-2020/.

The sponsors of ISO 32000-2 provide capable viewers:
