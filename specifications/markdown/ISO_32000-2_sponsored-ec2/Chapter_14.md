...
ISO 32000-2:2020(E)
718 © ISO 2020 – All rights reserved
...
ISO 32000-2:2020(E)
726 © ISO 2020 – All rights reserved
Key Type Value
...
pronunciation hint. It is an exact replacement for content enclosed by t he
...
EXAMPLE The following example shows a str ucture element containing user properties called Part Name, Part
...
ISO 32000-2:2020(E)
742 © ISO 2020 – All rights reserved
...
Type
Category Description
Div Grouping Encloses content structured in fashion that is orthogonal to the sema ntic
...
EXAMPLE 3 The follo wing is just one of the possible types of content that
...
ISO 32000-2:2020(E)
760 © ISO 2020 – All rights reserved
Structure
Type
Category Description
...
• in footnotes, the number or symbol ma tching the reference from the
text
...
EXAMPLE 7 The following are the possible types of co ntent that could be marked as
Form:
...
wrap across multiple lines, according to the warichu break ing rules
...
ISO 32000-2:2020(E)
778 © ISO 2020 – All rights reserved
Key Type Value
...
0.0 to 1.0, representing the red, green, and blue values, res pectively, of
...
ISO 32000-2:2020(E)
782 © ISO 2020 – All rights reserved
Key Type Value
Width number
or name
...
TPadding. A positive value shall enlarge the background area; a nega tive
...
Auto, if specified, shall be used directly if they are available i n the
target format.
...
EXAMPLE 1 This example shows how a language specified for the document as a whole could be overri dden by one
...
content is that of the structure element, English.
 This example omi ts required StructParents entries in the objects used as content items ( see 14.7.5.4,
"Finding structure elements from content items").
1 0 obj             %Structure element
  <</Type /StructElem
   /S /P           %Structure type
...
The E (expiration) entry specifies an expiration date for each source location associated with a content set. If th e
...
EXAMPLE 1 the URL http://www.iso.org/fiddle/faddle/foo.html is considered to be in the same path as the initi al URL
 Sold by the PDF Association to Olivier Chatelain  19713 | May 26, 2026 |
 Single user only, copying and networking prohibited.
...
F file
specification
%%ImageFilename (Required) The external file containing the
low-resolution proxy image.
MainImage byte string %%MainImage (Optional) The pathname of the file
...
ISO 32000-2:2020(E)
© ISO 2020 – All rights reserved 843
>>
endobj
...
ISO 32000-2:2020(E)
844 © ISO 2020 – All rights reserved
