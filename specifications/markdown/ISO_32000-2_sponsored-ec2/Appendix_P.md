...
> **NOTE** Isolated transparency groups with a device colour space as blending colour space first apply the default colour space mechanism. In case of no valid default colour space remapping, the ancestor transparency groups are searched – starting with the nearest - for a possible blending colour space to inherit from.
