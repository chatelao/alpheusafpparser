...
* **MOFormat**: MOFormat is defined in the Metadata Object Content Architecture to indicate the format of MO data. See “MOFormat” on page 15. If an invalid or unsupported value is found in this field, the optional exception is EC-0230.
* **MOCompression**: MOCompression is defined in the Metadata Object Content Architecture to indicate the type of compression applied to MO data. See “MOCompression” on page 16. If an invalid or unsupported value is found in this field, the optional exception is EC-0240.
