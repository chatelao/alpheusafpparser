...
| | LENGTH (1) | X'02' | |
| | COMPRID (1) | X'01', X'03', X'82' | X'01' IBM MMR<br>X'03' No compression<br>X'82' G4 MMR |
| | RECID (1) | X'01' | RIDIC |
| IDE Size | ID (1) | X'96' | |
| | LENGTH (1) | X'01' | |
...
Note: The External Algorithm Specification parameter is part of FS11, but in IOCA is no longer required for JPEG compression, as described in Note 2 in the description of the Image Encoding parameter. Thus, an FS11 receiver can ignore the External Algorithm Specification parameter if desired.
...
| Image Encoding | ID (1) | X'95' | |
| | LENGTH (1) | X'02' – X'03' | |
| | COMPRID (1) | X'01', X'03', X'08', X'0A', X'82', X'83' | X'01' IBM MMR (see Note 1)<br>X'03' No Compression<br>X'08' ABIC (see Note 1)<br>X'0A' Concatenated ABIC (see Note 2)<br>X'82' G4 MMR (see Note 1)<br>X'83' JPEG (see Note 3) |
| | RECID (1) | X'01' | RIDIC |
| | BITORDR (1) | X'00' – X'01' | X'00' L-to-R<br>X'01' R-to-L |
| IDE Size | ID (1) | X'96' | |
| | LENGTH (1) | X'01' | |
| | IDESZ (1) | X'01', X'04', X'08', X'18' | X'01' 1 bit/IDE<br>X'04' 4 bits/IDE<br>X'08' 8 bits/IDE<br>X'18' 24 bits/IDE |
| External Algorithm Specification | ID (1) | X'9F' | |
| | LENGTH (1) | X'0A' | |
...
| | MARKER (1) | X'C0' – X'C2', X'C9' – X'CA' | **Non-differential Huffman coding:**<br>X'C0' Baseline DCT<br>X'C1' Extended sequential DCT<br>X'C2' Progressive DCT<br>**Non-differential arithmetic coding:**<br>X'C9' Extended sequential DCT<br>X'CA' Progressive DCT<br>See Note 3 |
| | RESERVED (3) | X'000000' | Should be zero |
...
| IDE Structure | ID (1) | X'9B' | |
| | LENGTH (1) | X'06' – X'08' | |
| | FLAGS (1) | | ASFLAG B'0' Additive<br>GRAYCODE B'0'–B'1' (see Note 1)<br>RESERVED B'000000' |
| | FORMAT (1) | X'02', X'12' | X'02' YCrCb (see Note 2)<br>X'12' YCbCr (see Note 2) |
| | RESERVED (3) | X'000000' | Should be zero |
...
| | RESERVED (3) | X'000000' | Should be zero |
| | SIZE1 (1) | X'08' | 8 bits for R or Y component |
| | SIZE2 (1) | X'08' | 8 bits for G or Cr or Cb component |
| | SIZE3 (1) | X'08' | 8 bits for B or Cb or Cr component |
| Image Subsampling (see General Note) | ID (2) | X'FECE' | |
...
| | DATA | Any | IDEs |
| or: | | | |
| Band Image Data (BCOUNT=1) | ID (2) | X'FE9C' | |
| | LENGTH (2) | X'0004' – X'FFFF' | |
| | BANDNUM (1) | X'01' | One band |
| | RESERVED (2) | X'0000' | Should be zero |
| | DATA | Any | IDEs |
| or: | | | |
| Band Image Data (BCOUNT=3) | ID (2) | X'FE9C' | |
| | LENGTH (2) | X'0004' – X'FFFF' | |
| | BANDNUM (1) | X'01' | Band with R or Y component |
| | RESERVED (2) | X'0000' | Should be zero |
| | DATA | Any | R or Y component |
| | ID (2) | X'FE9C' | |
| | LENGTH (2) | X'0004' – X'FFFF' | |
| | BANDNUM (1) | X'02' | Band with G, Cr, or Cb component |
| | RESERVED (2) | X'0000' | Should be zero |
| | DATA | Any | G, Cr, or Cb component |
| | ID (2) | X'FE9C' | |
| | LENGTH (2) | X'0004' – X'FFFF' | |
| | BANDNUM (1) | X'03' | Band with B, Cb, or Cr component |
| | RESERVED (2) | X'0000' | Should be zero |
| | DATA | Any | B, Cb, or Cr component |
| End Image Content | ID (1) | X'93' | |
| | LENGTH (1) | X'00' | |
| End Segment | ID (1) | X'71' | |
| | LENGTH (1) | X'00' | |
...
Function Set 45 is a superset of Function Set 40 and Function Set 42 and a subset of Function Set 48. It describes bilevel or color tiled images. This function set is carried by the MO:DCA and IPDS controlling environments. The permissible parameter groupings in FS45 are defined as follows:
...
| Image Encoding | ID (1) | X'95' | |
| | LENGTH (1) | X'02' – X'03' | |
| | COMPRID (1) | X'01', X'03', X'08', X'0D', X'20', X'82' – X'83' | X'01' IBM MMR (see Note 2)<br>X'03' No Compression<br>X'08' ABIC (see Note 2)<br>X'0D' TIFF LZW<br>X'20' Solid Fill Rectangle<br>X'82' G4 MMR (see Note 2)<br>X'83' JPEG algorithms (see Note 3) |
| | RECID (1) | X'01', X'04' | X'01' RIDIC<br>X'04' Unpadded RIDIC |
| | BITORDR (1) | X'00' – X'01' | X'00' L-to-R<br>X'01' R-to-L |
| IDE Size | ID (1) | X'96' | |
| | LENGTH (1) | X'01' | |
| | IDESZ (1) | X'01', X'04', X'20' | X'01' 1 bit/IDE<br>X'04' 4 bits/IDE<br>X'20' 32 bits/IDE |
...
| | THSIZE (4) | X'00000000' – X'7FFFFFFF' | Horizontal tile size |
| | TVSIZE (4) | X'00000000' – X'7FFFFFFF' | Vertical tile size |
| | RELRES (1) | X'01' – X'02' | Relative resolution (see Note) |
...
| Image Encoding | ID (1) | X'95' | |
| | LENGTH (1) | X'02' – X'03' | |
| | COMPRID (1) | X'01', X'03', X'08', X'20', X'82' | X'01' IBM MMR<br>X'03' No Compression<br>X'08' ABIC<br>X'20' Solid Fill Rectangle<br>X'82' G4 MMR |
| | RECID (1) | X'01', X'04' | X'01' RIDIC<br>X'04' Unpadded RIDIC |
| | BITORDR (1) | X'00' – X'01' | X'00' L-to-R<br>X'01' R-to-L |
| IDE Size | ID (1) | X'96' | |
| | LENGTH (1) | X'01' | |
...
| IDE Structure | ID (1) | X'9B' | |
| | LENGTH (1) | X'06' – X'08' | |
| | FLAGS (1) | | ASFLAG B'0' Additive<br>GRAYCODE B'0' No gray coding<br>RESERVED B'00000' |
| | FORMAT (1) | X'02', X'12' | X'02' YCrCb<br>X'12' YCbCr |
| | RESERVED (3) | X'000000' | |
| | SIZE1 (1) | X'01' | 1 bit/IDE |
| | SIZE2 (1) | X'00' | 0 bits/IDE |
...
| Image Encoding | ID (1) | X'95' | |
| | LENGTH (1) | X'02' – X'03' | |
| | COMPRID (1) | X'01', X'03', X'08', X'82' | X'01' IBM MMR<br>X'03' No Compression<br>X'08' ABIC<br>X'82' G4 MMR |
| | RECID (1) | X'01', X'04' | X'01' RIDIC<br>X'04' Unpadded RIDIC |
| | BITORDR (1) | X'00' – X'01' | X'00' L-to-R<br>X'01' R-to-L |
| IDE Size | ID (1) | X'96' | |
| | LENGTH (1) | X'01' | |
...
| Image Size | ID (1) | X'94' | |
| | LENGTH (1) | X'09' | |
| | UNITBASE (1) | X'00' – X'01' | X'00' 10 in; X'01' 10 cm |
| | HRESOL (2) | X'0001' – X'7FFF' | |
| | VRESOL (2) | X'0001' – X'7FFF' | |
| | HSIZE (2) | X'0001' – X'7FFF' | |
| | VSIZE (2) | X'0001' – X'7FFF' | |
...
| | | | Four bands, in order by BANDNUM, in the following format: |
| | ID (2) | X'FE9C' | |
| | LENGTH (2) | X'0003' – X'FFFF' | (see Note) |
| | BANDNUM (1) | X'01' – X'04' | X'01' Band contains C component<br>X'02' Band contains M component<br>X'03' Band contains Y component<br>X'04' Band contains K component |
| | RESERVED (2) | X'0000' | |
| | DATA | Any | |
| End Tile | ID (1) | X'8D' | |
...
**Note on the tile-final parameters:** Band Image Data parameters with length of X'0003' do not have a data field. The receiver generates zeros for the corresponding band.

| IOCA Self-defining Field | Parameter (Bytes) | Acceptable Value | Comments |
| :--- | :--- | :--- | :--- |
| **Final parameters in FS45:** | | | |
| End Image Content | ID (1) | X'93' | |
| | LENGTH (1) | X'00' | |
| End Segment | ID (1) | X'71' | |
| | LENGTH (1) | X'00' | |
...
7. Receivers implementing FS48 must support at least 128 image contents in a single image segment. Otherwise, if a receiver encounters too many image contents to process, it should act as if it encountered too many image objects on a page.
8. Resource tiles included via the Include Tile parameter must not contain the Include Tile parameter or the exception EC-B811 exists.
...
| Image Encoding | ID (1) | X'95' | |
| | LENGTH (1) | X'02' – X'03' | |
| | COMPRID (1) | X'01', X'03', X'08', X'0D', X'0E', X'20', X'82' – X'83' | X'01' IBM MMR (see Note 2)<br>X'03' No Compression<br>X'08' ABIC (see Note 2)<br>X'0D' TIFF LZW<br>X'0E' TIFF LZW with Diff Predictor<br>X'20' Solid Fill Rectangle<br>X'82' G4 MMR (see Note 2)<br>X'83' JPEG algorithms (see Note 3) |
| | RECID (1) | X'01', X'04' | X'01' RIDIC<br>X'04' Unpadded RIDIC |
| | BITORDR (1) | X'00' – X'01' | X'00' L-to-R<br>X'01' R-to-L |
| IDE Size | ID (1) | X'96' | |
| | LENGTH (1) | X'01' | |
| | IDESZ (1) | X'01', X'04', X'10', X'18', X'20', X'28', X'30', X'38', X'40', X'48', X'50', X'58', X'60', X'68', X'70', X'78' | X'01' 1 bit/IDE<br>X'04' 4 bits/IDE<br>X'10'–X'78' 16–120 bits/IDE |
...
2. ABIC (Bilevel Q-Coder), IBM MMR-Modified Modified Read, G4 MMR-Modified Modified READ, and Solid Fill Rectangle are applicable only to images whose IDE size is 1 bit/band, otherwise exception condition EC-9611 is raised.
3. The JPEG algorithms are applicable only to CMYK images whose IDE size is 32 bits/IDE or to nColor images; otherwise exception condition EC-9611 is raised.
...
| Image Encoding | ID (1) | X'95' | |
| | LENGTH (1) | X'02' – X'03' | |
| | COMPRID (1) | X'03', X'0D', X'0E', X'83' | X'03' No Compression<br>X'0D' TIFF LZW<br>X'0E' TIFF LZW with Diff Predictor<br>X'83' JPEG |
| | RECID (1) | X'01', X'04' | X'01' RIDIC<br>X'04' Unpadded RIDIC |
| | BITORDR (1) | X'00' – X'01' | X'00' L-to-R<br>X'01' R-to-L |
| IDE Size | ID (1) | X'96' | |
| | LENGTH (1) | X'01' | |
...
| IDE Size | ID (1) | X'96' | |
| | LENGTH (1) | X'01' | |
| | IDESZ (1) | X'10', X'18', X'20', X'28', X'30', X'38', X'40', X'48', X'50', X'58', X'60', X'68', X'70', X'78' | X'10'–X'78' 16–120 bits/IDE (n=2–15) |
| Band Image | ID (1) | X'98' | |
| | LENGTH (1) | X'03' – X'10' | |
| | BCOUNT (1) | X'02' – X'0F' | 2–15 bands |
| | BITCNT (1) | X'08' | 8 bits/IDE for each band |
| IDE Structure | ID (1) | X'9B' | |
| | LENGTH (1) | X'07' – X'14' | |
| | FLAGS (1) | | ASFLAG (Ignored)<br>GRAYCODE B'0' No gray coding<br>RESERVED B'000000' |
| | FORMAT (1) | X'8n' | nColor (X'2' ≤ n ≤ X'F') |
| | RESERVED (3) | X'000000' | |
| | SIZE1–SIZEn (1) | X'08' | 8 bits/IDE for each component |
...
| IOCA Self-defining Field | Parameter (Bytes) | Acceptable Value | Comments |
| :--- | :--- | :--- | :--- |
| **Image Data** | (IDESZ=1 only) | | |
| | ID (2) | X'FE92' | |
| | LENGTH (2) | X'0001' – X'FFFF' | |
| | DATA | Any | IDEs (bilevel only) |
| *or:* | | | |
| **Band Image Data** | (FORMAT=CMYK only) | | |
| | | | Four bands, in order by BANDNUM, in the following format: |
| | ID (2) | X'FE9C' | |
| | LENGTH (2) | X'0003' – X'FFFF' | (see Note) |
| | BANDNUM (1) | X'01' – X'04' | X'01' Band contains C component<br>X'02' Band contains M component<br>X'03' Band contains Y component<br>X'04' Band contains K component |
...
| | DATA | Any | |
| *or:* | | | |
| **Band Image Data** | (FORMAT=nColor only) | | |
...
**Note on the tile-final parameters:** Band Image Data parameters with a length of X'0003' do not have a data field. The receiver generates zeros for the corresponding band.

| IOCA Self-defining Field | Parameter (Bytes) | Acceptable Value | Comments |
| :--- | :--- | :--- | :--- |
| **Final parameters in FS48:** | | | |
| End Image Content | ID (1) | X'93' | |
| | LENGTH (1) | X'00' | |
| End Segment | ID (1) | X'71' | |
| | LENGTH (1) | X'00' | |
