...
• Different applications, which can be independent of one another, create source data (such as graphics,
...
• IPDS data streams are independent of the carrying communications protocol. This allows the transmission of
...
• IPDS products transfer all data and controls through self-identifying structured fields, called IPDS
...
• IPDS architecture provides an extensive acknowledgment protocol at the data-stream level. This
