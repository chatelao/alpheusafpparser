...
• Set Line Width (GSLW) order. The required support is normal line width, plus a further line width selectable by a multiplier of two.
...
Architecture Notes:
1. Some AFP printers accept the Set Fractional Line Width (GSFLW) order.
...
- Set Process Color (SET = X'10') - Set Normal Line Width (SET = X'11')
...
• Support for the full range of possible line widths in the Set Line Width (GSLW) order
